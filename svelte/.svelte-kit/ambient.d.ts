...
declare module '$env/static/private' {
	...
	export const CELERY_BROKER_URL: string;
	...
	export const CDEKDB_READONLY_URL: string;
	export const npm_config_user_agent: string;
	export const AACT_DB_URL: string;
...
declare module '$env/static/public' {
	export const PUBLIC_DNS: string;
	export const PUBLIC_TITLE: string;
	export const PUBLIC_TAGLINE: string;
	export const PUBLIC_GITHUB: string;
	export const PUBLIC_TWITTER: string;
	export const PUBLIC_FACEBOOK: string;
	export const PUBLIC_SLACK: string;
	export const PUBLIC_INSTAGRAM: string;
}
...
declare module '$env/dynamic/public' {
	export const env: {
		...
		PUBLIC_GITHUB: string;
		PUBLIC_TWITTER: string;
